...
official/supported Docker Images found at https://hub.docker.com/r/blockcoinpay/blockcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/blockcoinpay/blockcoind-develop/ when changing the above text**