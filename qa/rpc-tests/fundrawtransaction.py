...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid blockcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid blockcoin address" in e.error['message'])
