...
This mechanism has been integrated into Bitcore-Node-Blockcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/blockcoinpay/insight-api-blockcoin#web-socket-api](https://github.com/blockcoinpay/insight-api-blockcoin#web-socket-api)
* API: [https://github.com/blockcoinpay/insight-api-blockcoin#instantsend-transactions](https://github.com/blockcoinpay/insight-api-blockcoin#instantsend-transactions)
...
By default, the Blockcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Blockcoin Core daemon:
