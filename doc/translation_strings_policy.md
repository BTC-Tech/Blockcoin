...
This document provides guidelines for internationalization of the Blockcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `blockcoin_en.ts` remains unchanged.
