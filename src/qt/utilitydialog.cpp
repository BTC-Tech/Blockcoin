    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  blockcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Blockcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BLC, 0.1 BLC, 1 BLC and 10 BLC -- sort of like the paper money you use every day.</li> \
