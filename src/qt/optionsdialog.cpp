    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BLC-light"), QVariant("light"));
    ui->theme->addItem(QString("BLC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BLC-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BLC-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BLC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BLC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BLC-traditional"), QVariant("trad"));
