/* src/config/blockcoin-config.h.  Generated from blockcoin-config.h.in by configure.  */
/* src/config/blockcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Blockcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Blockcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/blockcoinpay/blockcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Blockcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Blockcoin Core 0.12.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blockcoincore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://blockcoin.org/"
