...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Blockcoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "blockcoin",               "masternode",             &masternode,             true,  {} },
    { "blockcoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "blockcoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "blockcoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "blockcoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "blockcoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
